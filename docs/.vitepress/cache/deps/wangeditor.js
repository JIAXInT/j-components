...
// node_modules/.pnpm/wangeditor@4.7.15/node_modules/wangeditor/dist/wangEditor.js
var require_wangEditor = __commonJS({
  "node_modules/.pnpm/wangeditor@4.7.15/node_modules/wangeditor/dist/wangEditor.js"(exports, module) {
                  ...
                  if (uploadImgServer) {
                    ...
                    var xhr = upload_core_1["default"](uploadImgServer, {
                      ...
                      beforeSend: function beforeSend(xhr2) {
                        if (hooks.before) return hooks.before(xhr2, editor, resultFiles);
                      },
                      onTimeout: function onTimeout(xhr2) {
                        config.customAlert(t("上传图片超时"), "error");
                        if (hooks.timeout) hooks.timeout(xhr2, editor);
                      },
                      ...
                      onSuccess: function onSuccess(xhr2, result) {
                        ...
                        if (result.errno != "0") {
                          ...
                          if (hooks.fail) hooks.fail(xhr2, editor, result);
                          return;
                        }
                        ...
                        if (hooks.success) hooks.success(xhr2, editor, result);
                      }
                    });
            ...
            module2.exports = function(CONSTRUCTOR_NAME, wrapper, common) {
              ...
              if (!DESCRIPTORS || typeof NativeConstructor != "function" || !(IS_WEAK || NativePrototype.forEach && !fails(function() {
                ...
                Constructor = wrapper(function(target, iterable) {
                  ...
                  if (iterable != void 0) iterate(iterable, target[ADDER], target, IS_MAP);
                });
            ...
            function post(url, option) {
              ...
              xhr.onreadystatechange = function() {
                ...
                if (status >= 400) {
                  ...
                  if (option.onError) option.onError(xhr);
                  return;
                }
            ...
            var List = (
              ...
              function(_super) {
                ...
                List2.prototype.command = function(type) {
                  var editor = this.editor;
                  var $selectionElem = editor.selection.getSelectionContainerElem();
                  if ($selectionElem === void 0) return;
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            function parseHtml(html, filterStyle, ignoreImg) {
              ...
              function markTagStart(tag) {
                ...
                if (!tag) return;
                if (tags_1.EMPTY_TAGS.has(tag)) return;
                CUR_TAG = tag;
              }
              function markTagEnd() {
                CUR_TAG = "";
                  ...
                  events: [
                    // 插入链接
                    {
                      ...
                      fn: function fn() {
                        ...
                        if (!link2) return;
                        if (!text2) text2 = link2;
                        if (!checkLink(text2, link2)) return;
                ...
                events: [
                  // 插入视频
                  {
                    ...
                    fn: function fn() {
                      ...
                      if (!video2) return;
                      if (!checkOnlineVideo(video2)) return;
                      insertVideo(video2);
                      return true;
                    },
                    bindEnter: true
                ...
                UploadVideo2.prototype.uploadVideo = function(files) {
                  ...
                  if (uploadVideoServer) {
                    ...
                    var xhr = upload_core_1["default"](uploadVideoServer, {
                      ...
                      beforeSend: function beforeSend(xhr2) {
                        if (uploadVideoHooks.before) return uploadVideoHooks.before(xhr2, editor, resultFiles);
                      },
                      onTimeout: function onTimeout(xhr2) {
                        config.customAlert(t("上传视频超时"), "error");
                        if (uploadVideoHooks.timeout) uploadVideoHooks.timeout(xhr2, editor);
                      },
                      onProgress: function onProgress(percent, e) {
                        var progressBar = new progress_1["default"](editor);
                        if (e.lengthComputable) {
                      ...
                      onError: function onError(xhr2) {
                        ...
                        if (uploadVideoHooks.error) uploadVideoHooks.error(xhr2, editor);
                      },
                      onFail: function onFail(xhr2, resultStr) {
                        config.customAlert(t("上传视频失败"), "error", t("上传视频返回结果错误") + ("，" + t("返回结果") + ": ") + resultStr);
                        if (uploadVideoHooks.fail) uploadVideoHooks.fail(xhr2, editor, resultStr);
                      },
                      onSuccess: function onSuccess(xhr2, result) {
                        ...
                        if (result.errno != "0") {
                          ...
                          if (uploadVideoHooks.fail) uploadVideoHooks.fail(xhr2, editor, result);
                          return;
                        }
                        var data = result.data;
                        _this.insertVideo(data.url);
                        if (uploadVideoHooks.success) uploadVideoHooks.success(xhr2, editor, result);
                      }
                    });
                    if (typeof xhr === "string") {
                      config.customAlert(xhr, "error");
          ...
          function(module2, exports2, __webpack_require__) {
            ...
            function operateElement($node, type, editor) {
              ...
              if (reg.test($elem.getNodeName())) {
                if (type === "increase") increase_indent_style_1["default"]($elem, parseIndentation(editor));
                else if (type === "decrease") decrease_indent_style_1["default"]($elem, parseIndentation(editor));
              }
            }
